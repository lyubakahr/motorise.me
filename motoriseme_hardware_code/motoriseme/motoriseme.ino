...
const char* ssid     = "Lyubomir's iPhone";
const char* password = "kurcho21";
...
WiFiClient client;
float biggest_angle = 0;
bool leaned_bike = false;
...
float angle_treshold = 25.0;
 */
  if (angle_y >= angle_treshold) {
    leaned_bike = true; 
    if (angle_y > biggest_angle) {
        biggest_angle = angle_y;
    }
    if (angle_y > 76.0) {
      socket_server_connect();
      client.println("HELP ME");
      biggest_angle = 0;
      leaned_bike = false;
    }
  } else {
