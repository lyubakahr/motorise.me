    ...
    if request.method == 'POST':
        if request.user.is_authenticated():
            ...
            event = Event(name = request.POST['ride_name'],
                          ...
                          start_point_coordinates = request.POST['ride_start_point'],#request.POST['start_point_coordinates'],
                          end_point = request.POST['ride_end_point'],
                          end_point_coordinates = request.POST['ride_end_point'],#request.POST['end_point_coordinates'],
